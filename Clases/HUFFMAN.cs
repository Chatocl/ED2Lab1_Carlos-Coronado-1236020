...
namespace Clases
{
        ...
        public class Huffman<T> where T : IComparable
        {
            ...
            public List<int> Codificar(T value)
            {
                var AuxList = new List<int>();
                Codificar(value, AuxList);
                return AuxList;
            }

            public void Codificar(T value, List<int> Encode)
            {
            ...
            public T Decodificar(List<int> bitString, ref int pos)
            {
            ...
            public List<T> Decodificar(List<int> bitString)
            {
                ...
                {
                    AuxList.Add(Decodificar(bitString, ref Pos));
                }
                return AuxList;
            }
